...
mydata <- read.table(file = "figure_2D_dataset.txt",sep = "\t", header = TRUE) # !!! test sep character
...
# T-test to compare plants with HR and without
group_1="no_HR"
group_2="HR"
ET_no_HR = data[data[,5]==group_1,]$ET
ET_HR = data[data[,5]==group_2,]$ET
...
plot(plot)
ggsave("figure_2D.png", plot=plot, width = 6, height = 6, units="in")
dev.off()
